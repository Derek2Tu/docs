...
| Model | Developer  | Carbon Slug
| -------- | ------------- | ------|
| Embeddings for Multimodal     | Google  | `JINA_MULTILINGUAL_BASE_V2`
| Embeddings for Multimodal     | Google  | `COHERE_RERANK_MULTILINGUAL_V3`

#### Video Embeddings

<Warning>Currently do not designate `VERTEX_MULTIMODAL` as an `embedding_model`. This model is automatically employed by Carbon when processing a video file.</Warning>
