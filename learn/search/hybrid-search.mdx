...
<Info>Please keep in mind hybrid search is slower than non-hybrid search. For more details on the different search techniques, please reference this [article](https://carbon.ai/blog/hybrid-and-semantic-search).</Info>
