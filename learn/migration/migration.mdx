...
Upload the appropriate files for the embeddings and chunks through the `uploadfile` endpoint. If you plan to upload existing embeddings for the files, set `skip_embedding_generation` to true.
