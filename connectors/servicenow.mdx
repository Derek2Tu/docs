---
title: 'ServiceNow'
description: 'The Carbon Connect `enabledIntegrations` value for ServiceNow is `SerivceNow`.'
---
...
No additional endpoints are required for the ServiceNow integration.
