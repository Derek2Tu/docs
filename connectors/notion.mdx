...
7. Add https://api.carbon.ai/integrations/notion as the "Redirect URIs". You can use a custom CNAME record pointing to https://api.carbon.ai but the domain path must still be /integrations/notion.
