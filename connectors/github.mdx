...
- `/pull_requests`: Lists all pull requests for a repository
- `/pull_requests/{pull_number}`: Retrieves a specific pull request
- `/pull_requests/comments`: Fetches comments on a pull request
- `/pull_requests/files`: Retrieves files that were changed
- `/pull_requests/commits`: Retrieves a list of commits on a pull request
- `/issues`: Lists repository issues
- `/issues/{issue_number}`: Retrieves a specific issue
