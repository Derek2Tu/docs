...
Carbon currently supports syncing individual folders and files within repositories, rather than entire repositories. To list the items within a repository, pass the `external_id` (repository ID) as the `parent_id` parameter.
