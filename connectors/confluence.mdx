...
As of now, a File Selector UI for Confluence is in development and will be available soon.

Meanwhile, you can synchronize Confluence pages using the following steps:
