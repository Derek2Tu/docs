...
#### Step 1: List Files and Buckets
You can list all available GCS buckets and objects by using _*POST*_ `/integrations/items/sync` and list them via _*POST*_ `/integrations/items/list`.

#### Step 2: Sync Files or Buckets
Use the `/integrations/gcs/files` endpoint to sync specific file objects or buckets.
