...
After successfully connecting your Outlook account, you have the flexibility to choose which emails to sync using the filters and folder parameters.
...
- _*`category`*_: Custom categories created in Outlook.

- _*`after or before`*_: A date in YYYY/mm/dd format (e.g., 2023/12/31) to fetch emails after/before a specific date.
You can combine these filters for more refined queries. 
