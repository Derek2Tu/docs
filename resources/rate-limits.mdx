...
Here is the development documentation for the API rate limits:
...
Requests that exceed the rate limits will receive a 429 Too Many Requests HTTP status code. Ensure your application adheres to these rate limits to avoid being throttled.
