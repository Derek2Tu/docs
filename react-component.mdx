...
Our _*Google Drive*_ connector is under review by Google. If you see a warning message when connecting your account, please ignore it and proceed.
...
3. `WEB_SCRAPER`: This integration lets you scrape URLs. You can pass the following configuration for this integration:
   ...
   - `overlapSize`: This is the size of the overlap in tokens. Defaults to 20.
    ...
    - `skipEmbeddingGeneration`: Whether or not to skip embeddings generation. Defaults to `false`.
   - `enableAutoSync`: Whether or not you want to enable scheduled syncs. Defaults to `false`.
...
7. `ZENDESK`: This integration lets you upload files from your Zendesk. You can pass the following configuration for this integration:
   - `chunkSize`: This is the no.of tokens per chunk. Defaults to 1500.
   - `overlapSize`: This is the size of the overlap in tokens. Defaults to 20.
   - `skipEmbeddingGeneration`: Whether or not to skip embeddings generation. Defaults to `false`.
